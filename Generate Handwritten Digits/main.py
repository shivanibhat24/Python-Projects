...
#Loading the dataset and training it
(train_images, train_labels),(_,_)=tf.keras.datasets.mnist.load_data()
train_images=train_images.reshape(train_images.shape[0],28,28,1).astype('float32')
train_images=(train_images-127.5)/127.5 #Here, we normalise the images to [-1,1]
...
#using the untrained generator to generate images using random noise
...
#Optimisers for discriminator and generator
